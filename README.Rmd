...
Now we have two 12 image `ImageCollection`s each with one band ("NDVI_mean","NDVI_sd"). We can join these bands using an `inner_join`. The common property that should be used for this band is "month" since we want the monthly mean and standard deviation for each month to be aligned
